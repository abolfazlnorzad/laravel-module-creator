...
namespace Nrz\LaravelModuleCreator\Helpers;

use Nrz\LaravelModuleCreator\Exceptions\File\FileIsNotWritableException;
use Nrz\LaravelModuleCreator\Exceptions\File\FileNotExistException;
